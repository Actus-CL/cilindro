...
<html lang="<?php echo e(config('app.locale')); ?>">
    ...
    <!-- Fonts -->
        ...
        <script> window.Laravel = {"locale":"es"}</script>
    </head>
    <body>
        <div class="flex-center position-ref full-height">

                <div class="top-right links">
                    <a href="<?php echo e(route('protection.cliente.perfil')); ?>">Portal de clientes</a>
                    ...
                    <?php if(Route::has('login')): ?>
                        ...
                        <?php else: ?>
                            <?php if(auth()->user()->hasRole('administrator')): ?>
                                <a href="<?php echo e(url('/admin')); ?>">Administrador</a>
                            <?php endif; ?>
                            <a href="<?php echo e(url('/logout')); ?>">Cerrar sesion</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
